    ...
    public class CSConsolePanel : UEPanel
    {
        ...
        private void InvokeOnValueChanged(string value)
        {
            if (value.Length == UniversalUI.MAX_INPUTFIELD_CHARS)
                ExplorerCore.LogWarning($"达到最大输入字段字符长度! ({UniversalUI.MAX_INPUTFIELD_CHARS})");
        ...
        protected override void ConstructPanelContent()
        {
            ...
            ButtonRef resetButton = UIFactory.CreateButton(toolsRow, "ResetButton", "重置", new Color(0.33f, 0.33f, 0.33f));
            ...
            GameObject helpDrop = UIFactory.CreateDropdown(toolsRow, "HelpDropdown", out Dropdown dropdown, "帮助", 14, null);
            ...
            ctrlRToggleText.text = "按 Ctrl+R 编译";
